...
pbe_county = read.csv("/Users/graceliu/Documents/2018-2019 MSPH/2018 Fall/P8105 Data Science/gswliu.github.io/CA_County-level_Exemptions.csv", colClasses = c('character')) %>% 
